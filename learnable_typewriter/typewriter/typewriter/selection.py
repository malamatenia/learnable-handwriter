...
class Selection(nn.Module):
    def __init__(self, dim_enc, dim_sprites, group, factoring, logger):
        ...
        self.register_buffer('factoring', torch.from_numpy(factoring)) # |A| times |c|
    ...
    def compute_logits(self, x, sprites):
        ...
        print(latents.size(), self.factoring.size())
        latents = self.factoring.T.matmul(latents)
    ...
    def forward(self, x, sprites):
        ...
        print(probs.size(), self.factoring.size())
